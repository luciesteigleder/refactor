import Data from "/project_Template/config.js";
...
searchBar.addEventListener('keyup', (event) => {
    ...
    if(event.key === "Enter") {
        ...
        const apiUrl = "http://api.openweathermap.org/geo/1.0/direct?q=" + thisCity + "&appid=" + Data.key;
        ...
        fetch(apiUrl)
            ...
            .then(data => {
                ...
                fetch("http://api.openweathermap.org/data/2.5/forecast?lat=" + lat + "&lon=" + lon + "&cnt=5&units=metric&exclude=minutely,hourly,alerts&appid=" + Data.key)
                    .then(response => response.json())
                    .then(result => {
